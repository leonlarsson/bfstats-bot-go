...
func GetCommands() []discord.ApplicationCommandCreate {
	...
	statsNameLocalizations := localization.BuildDiscordLocalizations[discord.Locale]("slash_commands/stats/name")
	statsDescription := localization.GetEnglishString("slash_commands/stats/bf2042_description")
	statsDescriptionLocalizations := localization.BuildDiscordLocalizations[discord.Locale]("slash_commands/stats/bf2042_description")

	segmentName := localization.GetEnglishString("slash_commands/stats/options/segment/name")
	segmentNameLocalizations := localization.BuildDiscordLocalizations[discord.Locale]("slash_commands/stats/options/segment/name")
	segmentDescription := localization.GetEnglishString("slash_commands/stats/options/segment/description")
	segmentDescriptionLocalizations := localization.BuildDiscordLocalizations[discord.Locale]("slash_commands/stats/options/segment/description")
	...
	return []discord.ApplicationCommandCreate{
		...
		discord.SlashCommandCreate{
			...
			DescriptionLocalizations: localization.BuildDiscordLocalizations[discord.Locale]("slash_commands/base/bf2042_description"),
